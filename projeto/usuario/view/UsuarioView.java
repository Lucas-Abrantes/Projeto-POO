...
public class UsuarioView {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    if (resposta.equalsIgnoreCase("sim")) {
                       try {
                            controleUser.autenticarUser(scanner);
                            menuUsuario();
                       } catch (Exception e) {
    ...
    public void gerenciarUsuario(Scanner scanner) {
        ...
        switch (opcaoGerencial) {
          ...
          case 1:
            System.out.println("Digite o nome de usuario que deseja remover: ");
            String username = scanner.nextLine();
            try {
                controleUser.excluirUsuario(username);
            } catch (IOException e) {
                System.out.println("Erro ao remover usuário: " + e.getMessage());
            }
            break;
          case 2:
            System.out.println("Digite o nome de usuario que deseja visualizar: ");
            String foundUser = scanner.nextLine();
            try {
                controleUser.visualizarUsuario(foundUser);
            } catch (IOException e) {
        ...
        while (true) {
            ...
            switch (opcao) {
                ...
                case 3:
                    ...
                    try {
                        if (reserva.verificaReserva(check)) {
