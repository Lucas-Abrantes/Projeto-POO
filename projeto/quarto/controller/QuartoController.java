...
public class QuartoController {
    private static final String FILE_PATH = "projeto-POO/projeto/data/quartos.txt";
    private static final String DELIMITER = ",";
    public SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");


    public void inserirQuarto(Scanner scanner) throws IOException {
    ...
    public void criarQuarto(Quarto quarto) throws IOException {
    ...
    private String formatQuartoData(Quarto quarto) {
    ...
    public List<Quarto> listarQuartos() throws IOException {
    ...
    public void excluirQuarto(int numero) throws IOException {
        List<Quarto> quartos = listarQuartos();
        boolean found = false;
    ...
    public boolean verificarDisponibilidade(int numero) throws IOException {
    ...
    public void editarQuarto(Scanner scanner) throws IOException {
        System.out.println("");
    ...
    public List<Integer> verificarDisponibilidadePorData(Scanner scanner) throws IOException {
        List<Integer> quartosDisponiveis = new ArrayList<>();
        List<Quarto> quartos = listarQuartos();
        System.out.print("Inclua a data para a verificacao(dd-MM-yyyy): ");
    ...
    public String visualizarQuarto(int numero) throws IOException {
        List<Quarto> quartos = listarQuartos();
        if (quartos.isEmpty()) {
