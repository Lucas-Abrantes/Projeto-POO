...
public class PagamentoController {
    public static final String FILE_PATH = "projeto-POO/projeto/data/pagamentos.txt";
    ...
    // Visualização de pagamento por ID
public void visualizarPagamento(int id) throws IOException {
    ...
    public void criarPagamento(Pagamento pagamento) throws IOException {
        List<Pagamento> pagamentos = listarPagamentos();
    ...
    public String formatPagamentoData(Pagamento pagamento) {
    ...
    public void editarPagamento(Scanner scanner) throws IOException {
        System.out.println("");
    ...
    public void excluirPagamento(int id) throws IOException {
        List<Pagamento> pagamentos = listarPagamentos();
        boolean encontrado = false;
        try (PrintWriter out = new PrintWriter(new FileWriter(FILE_PATH))) {
            for (Pagamento pagamento : pagamentos) {
